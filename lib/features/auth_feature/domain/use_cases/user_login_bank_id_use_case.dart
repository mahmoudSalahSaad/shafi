...
class UserLoginBankIdUseCase extends BaseUseCase<UserModel, UserEntity> {
  final AuthRepository authRefreshRepository;

  UserLoginBankIdUseCase({required this.authRefreshRepository});
  /*
  * USE CASE
  * base on BaseUseCase
  ...
  * */
  ...
  Future<Either<ErrorModel, UserModel>> call(UserEntity parameters) async {
    return await authRefreshRepository.userLoginWithBankId(parameters);
  }
